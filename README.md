...
- The I/O Block is sub-divided into 128 devices, with 16 addresses each. Address 0 will be a type indicator, so that the coldboot ROM can address it with a defined protocol.
